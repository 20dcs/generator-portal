              ...
              <Grid
                ...
                <InputGroup width='90vh'>
                  ...
                  <Input
                    ...
                    isInvalid={errors?.projectTitle2 ? true : false}
                    placeholder='Notes'
                    width='64vh'
                  />
                </InputGroup>
                <InputGroup width='90vh'>
                  ...
                  <Textarea
                    ...
                    isInvalid={errors?.projectDescription2 ? true : false}
                    placeholder='Lorem ispsum'
                    width='64vh'
                  />
                </InputGroup>
                <InputGroup width='90vh'>
                  ...
                  <Input
                    ...
                    isInvalid={errors?.projectLink2 ? true : false}
                    placeholder='demoNotes.com'
                    width='64vh'
                  />
                </InputGroup>
                <InputGroup width='90vh'>
                  ...
                  <Input
                    id='projectImgLink2'
                    name='projectImgLink2'
                    {...register('projectImgLink2', {
                      required: 'This is required',
                    })}
                    isInvalid={errors?.projectImgLink2 ? true : false}
                    placeholder='NotesImage.jpg'
                    width='64vh'
                  />
                </InputGroup>
